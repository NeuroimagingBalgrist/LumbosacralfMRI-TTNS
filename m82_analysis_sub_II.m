...
result_p_image = struct( ...
    'p_5sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, 5, run, ses, 5, run)))}, ...
    'p_7sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, 7, run, ses, 7, run)))}, ...
    'p_9sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, 9, run, ses, 9, run)))}, ...
    'p_11sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, 11, run, ses, 11, run)))}, ...
    'p_13sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, 13, run, ses, 13, run)))}, ...
    'p_15sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, 15, run, ses, 15, run)))}, ...
    'p_17sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, 17, run, ses, 17, run)))}, ...
    'p_19sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, 19, run, ses, 19, run)))}, ...
    'p_21sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, 21, run, ses, 21, run)))}, ...
    'p_23sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, 23, run, ses, 23, run)))}, ...
    'p_25sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, 25, run, ses, 25, run)))});
result_p_name = fieldnames(result_p_image);

result_t_image = struct( ...
    't_5sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, 5, run, ses, 5, run)))}, ...
    't_7sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, 7, run, ses, 7, run)))}, ...
    't_9sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, 9, run, ses, 9, run)))}, ...
    't_11sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, 11, run, ses, 11, run)))}, ...
    't_13sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, 13, run, ses, 13, run)))}, ...
    't_15sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, 15, run, ses, 15, run)))}, ...
    't_17sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, 17, run, ses, 17, run)))}, ...
    't_19sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, 19, run, ses, 19, run)))}, ...
    't_21sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, 21, run, ses, 21, run)))}, ...
    't_23sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, 23, run, ses, 23, run)))}, ...
    't_25sub', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, 25, run, ses, 25, run)))});
