...
result_p_image = struct( ...
    'p_ses1_4_10min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "4run_10min", ses(1), sub, "4run_10min")))}, ...
    'p_ses1_4_8min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "4run_8min", ses(1), sub, "4run_8min")))}, ...
    'p_ses1_3_10min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "3run_10min", ses(1), sub, "3run_10min")))}, ...
    'p_ses1_4_6min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "4run_6min", ses(1), sub, "4run_6min")))}, ...
    'p_ses1_3_8min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "3run_8min", ses(1), sub, "3run_8min")))}, ...
    'p_ses1_2_10min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "2run_10min", ses(1), sub, "2run_10min")))}, ...
    'p_ses1_3_6min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "3run_6min", ses(1), sub, "3run_6min")))}, ...
    'p_ses1_2_8min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "2run_8min", ses(1), sub, "2run_8min")))}, ...
    'p_ses1_2_6min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "2run_6min", ses(1), sub, "2run_6min")))}, ...
    'p_ses2_4_10min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "4run_10min", ses(2), sub, "4run_10min")))}, ...
    'p_ses2_4_8min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "4run_8min", ses(2), sub, "4run_8min")))}, ...
    'p_ses2_3_10min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "3run_10min", ses(2), sub, "3run_10min")))}, ...
    'p_ses2_4_6min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "4run_6min", ses(2), sub, "4run_6min")))}, ...
    'p_ses2_3_8min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "3run_8min", ses(2), sub, "3run_8min")))}, ...
    'p_ses2_2_10min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "2run_10min", ses(2), sub, "2run_10min")))}, ...
    'p_ses2_3_6min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "3run_6min", ses(2), sub, "3run_6min")))}, ...
    'p_ses2_2_8min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "2run_8min", ses(2), sub, "2run_8min")))}, ...
    'p_ses2_2_6min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tfce_corrp_tstat1_cr.nii',pathRes, sub, "2run_6min", ses(2), sub, "2run_6min")))});
...
result_t_image = struct( ...
    't_ses1_4_10min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "4run_10min", ses(1), sub, "4run_10min")))}, ...
    't_ses1_4_8min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "4run_8min", ses(1), sub, "4run_8min")))}, ...
    't_ses1_3_10min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "3run_10min", ses(1), sub, "3run_10min")))}, ...
    't_ses1_4_6min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "4run_6min", ses(1), sub, "4run_6min")))}, ...
    't_ses1_3_8min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "3run_8min", ses(1), sub, "3run_8min")))}, ...
    't_ses1_2_10min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "2run_10min", ses(1), sub, "2run_10min")))}, ...
    't_ses1_3_6min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "3run_6min", ses(1), sub, "3run_6min")))}, ...
    't_ses1_2_8min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "2run_8min", ses(1), sub, "2run_8min")))}, ...
    't_ses1_2_6min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "2run_6min", ses(1), sub, "2run_6min")))}, ...
    't_ses2_4_10min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "4run_10min", ses(2), sub, "4run_10min")))}, ...
    't_ses2_4_8min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "4run_8min", ses(2), sub, "4run_8min")))}, ...
    't_ses2_3_10min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "3run_10min", ses(2), sub, "3run_10min")))}, ...
    't_ses2_4_6min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "4run_6min", ses(2), sub, "4run_6min")))}, ...
    't_ses2_3_8min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "3run_8min", ses(2), sub, "3run_8min")))}, ...
    't_ses2_2_10min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "2run_10min", ses(2), sub, "2run_10min")))}, ...
    't_ses2_3_6min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "3run_6min", ses(2), sub, "3run_6min")))}, ...
    't_ses2_2_8min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "2run_8min", ses(2), sub, "2run_8min")))}, ...
    't_ses2_2_6min', {double(niftiread(sprintf('%s/21_grplvl_randomise/%dof25sub/%s/%s_%dof25sub-mean_%s_tstat1_cr.nii',pathRes, sub, "2run_6min", ses(2), sub, "2run_6min")))});
...
plot(movmean(percent95_histo(:,data_selection(1)),10), slice, 'LineWidth',3.0, 'Color',"#EDB120")
hold on
plot(movmean(percent95_histo(:,data_selection(1)+9),10), slice, 'LineWidth',3.0, 'Color',"#EDB120",'LineStyle','--')
...
plot(movmean(percent95_histo(:,data_selection(2)),10), slice, 'LineWidth',3.0, 'Color',"#0072BD")
hold on
plot(movmean(percent95_histo(:,data_selection(2)+9),10), slice, 'LineWidth',3.0, 'Color',"#0072BD",'LineStyle','--')
...
plot(movmean(percent95_histo(:,data_selection(3)),10), slice, 'LineWidth',3.0, 'Color',"#A2142F")
hold on
plot(movmean(percent95_histo(:,data_selection(3)+9),10), slice, 'LineWidth',3.0, 'Color',"#A2142F",'LineStyle','--')
...
plot(movmean(percent95_RD_histo(:,data_selection(1)),10), slice, 'LineWidth',3.0, 'Color',"#EDB120")
hold on
plot(movmean(percent95_RD_histo(:,data_selection(1)+9),10), slice, 'LineWidth',3.0, 'Color',"#EDB120",'LineStyle','--')
...
hold on
plot(movmean(percent95_RD_histo(:,data_selection(2)+9),10), slice, 'LineWidth',3.0, 'Color',"#EDB120",'LineStyle','--')
...
plot(movmean(percent95_RD_histo(:,data_selection(3)),10), slice, 'LineWidth',3.0, 'Color',"#EDB120")
hold on
plot(movmean(percent95_RD_histo(:,data_selection(3)+9),10), slice, 'LineWidth',3.0, 'Color',"#EDB120",'LineStyle','--')
